...
Reference the [Publishing an Extension Catalog Image](../publishing#publishing-an-extension-catalog-image) step in the Publishing section for more information.
