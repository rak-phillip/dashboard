...
export default class SteveModel extends HybridModel {
  ...
  /**
   * Get the label for the resource type, with fallbacks to typeLabel translation and kind
   * @returns {string}
   *
   */
  get resourceTypeLabel() {
    return this.$rootGetters['type-map/labelFor'](this.schema) || this.t(`typeLabel."${ this.type }"`) || this.kind;
  }
  ...
  processSaveResponse(res) {
    ...
    // Split to remove the namespace if present (default/generated-xxx)
      ...
      if (nameOnly.length > 0) {
        const resource = this.resourceTypeLabel;
